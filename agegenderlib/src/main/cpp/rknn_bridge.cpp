...
namespace {
constexpr const char* TAG = "AgeGenderRKNN";
...
Java_com_zuicun_agegender_RknnSession_nativeCreate(
...
Java_com_zuicun_agegender_RknnSession_nativeRun(
...
Java_com_zuicun_agegender_RknnSession_nativeDestroy(
