...
namespace {
constexpr const char* TAG = "LipTalkRKNN";
...
Java_com_zuicun_liptalkdemo_RknnSession_nativeCreate(
...
Java_com_zuicun_liptalkdemo_RknnSession_nativeRun(
...
Java_com_zuicun_liptalkdemo_RknnSession_nativeDestroy(
